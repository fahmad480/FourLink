...
@section('title', 'My Link Groups - FourLink')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-folder"></i> My Link Groups
                </h2>
        ...
        @forelse($linkGroups as $linkGroup)
            <div class="col-md-6 col-lg-4">
                <div class="card link-group-card h-100">
                    ...
                    <div class="card-body">
                        @if(auth()->user()->isAdmin() && $linkGroup->user)
                            <small class="badge bg-info mb-2">
                                <i class="fas fa-user"></i> {{ $linkGroup->user->name }}
                            </small>
                        @endif
